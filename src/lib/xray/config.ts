 ...
 *
 * This is the bridge between Disruptor Proxy's model and the actual proxy core: every
 ...
 * keeps Disruptor Proxy out of their way. Disruptor Proxy routes the whole device via TUN anyway;
...
/**
 * Whether Disruptor Proxy can connect to this protocol with the current core. hysteria2
...
/**
 * Translates Disruptor Proxy's plain-language routing rules into Xray routing rules,
