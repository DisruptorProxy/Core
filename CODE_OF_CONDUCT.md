...
Because of what this project is, one more thing matters here: **do not post other people's
server details, subscription links, or credentials**, in issues, pull requests, or
discussions. Treat anything that could identify a user or an operator as private.
...
community leaders responsible for enforcement at **<!-- TODO: add a contact email or handle
before publishing -->**. All complaints will be reviewed and investigated promptly and fairly.
